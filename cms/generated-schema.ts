...
export interface SiteSetting {
  ...
  companyName: string;
  /**
   * International format without symbols, e.g. 6281234567890
   */
...
export interface HomePage {
  ...
  highlights?:
    | {
        title: string;
        description: string;
        icon: 'sparkles' | 'shield' | 'heart' | 'calendar' | 'check' | 'file' | 'zap' | 'headset';
        id?: string | null;
      }[]
    | null;
...
export interface HomePageSelect<T extends boolean = true> {
  ...
  servicesSecondaryDescription?: T;
  services?:
    | T
    | {
        title?: T;
  ...
  packagesContactText?: T;
  packagesContactCtaLabel?: T;
  packagesContactCtaHref?: T;
  orderFlowEyebrow?: T;
  orderFlowTitle?: T;
  orderFlowDescription?: T;
  orderFlowSteps?:
    | T
    | {
        icon?: T;
